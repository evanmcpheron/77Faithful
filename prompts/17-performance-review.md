...
- Trace applicable causes such as expensive renders/calculations, lists/images, startup, animations, request waterfalls, duplicate subscriptions, or application-data reads. Distinguish JavaScript, native/UI-thread, network, and backend work.
