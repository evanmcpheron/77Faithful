...
**Status:** New  
**Recommended path:** `src/components/form/text-area/text-area.component.tsx`

**Purpose**  
Multiline input for notes/remarks.
...
**Used in screens**  
Property notes, job notes, damage report.

**Composition**  
FieldContainer + multiline TextInput.
