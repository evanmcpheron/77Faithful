### JobTypeSegmentedControl

**Status:** New  
**Recommended path:**
`src/features/jobs/components/job-type-segmented-control.component.tsx`

**Purpose**  
Internal/external jobs toggle.
...
```ts
export interface IJobTypeSegmentedControlProps {
	id?: string;
	disabled?: boolean;
	testID?: string;
