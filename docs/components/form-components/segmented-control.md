...
**Status:** New  
**Recommended path:**
`src/components/form/segmented-control/segmented-control.component.tsx`

**Purpose**  
Small toggle between 2-4 options.
...
**Used in screens**  
Internal/external jobs, profile tabs, auth tabs if no body.

**Composition**  
Pressables + animated thumb optional.
