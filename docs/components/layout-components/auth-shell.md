...
**Status:** New  
**Recommended path:**
`src/components/layout/auth-shell/auth-shell.component.tsx`

**Purpose**  
Auth background/header/body shell extracted from auth screen.
...
**Composition**  
Header SVG + safe area + body card.
