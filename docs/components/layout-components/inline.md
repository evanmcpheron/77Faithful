...
**Status:** New  
**Recommended path:** `src/components/layout/inline/inline.component.tsx`

**Purpose**  
Horizontal layout primitive with gap/wrap.
...
Use instead of inline row styles.
