...
export type TReminderPreference = IEnabledReminderPreference | IDisabledReminderPreference;
...
export interface ILocalReminderSchedule {
  ...
  readonly reminders:
    readonly [] | readonly [IScheduledReminder] | readonly [IScheduledReminder, IScheduledReminder];
}
