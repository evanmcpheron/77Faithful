...
**Status:** New  
**Recommended path:**
`src/components/navigation/account-switcher-trigger/account-switcher-trigger.component.tsx`

**Purpose**  
Trigger for account/company switcher.
...
```ts
export interface IAccountSwitcherTriggerProps {
	children?: ReactNode;
	testID?: string;
}
```
