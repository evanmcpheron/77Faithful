...
**Status:** New  
**Recommended path:**
`src/components/form/field-container/field-container.component.tsx`

**Purpose**  
Shared label/helper/error wrapper for all fields.
...
FieldContainer owns label/error/helper, not value.
