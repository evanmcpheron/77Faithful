...
import type { TOptionalPracticeId, TPracticeId } from '../formation/practice.types';
import type {
  IDocumentTimestamps,
  IPersistedTimestamp,
  TCalendarDate,
...
export type TJourneyDayAccess = (typeof JourneyDayAccess)[keyof typeof JourneyDayAccess];

export interface IReachedDayOverview {
  access: typeof JourneyDayAccess.Current | typeof JourneyDayAccess.Historical;
  dayNumber: number;
