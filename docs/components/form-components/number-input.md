...
**Status:** New  
**Recommended path:**
`src/components/form/number-input/number-input.component.tsx`

**Purpose**  
Numeric input with parsing boundaries.
...
**Used in screens**  
Zip, sqft, room count, inventory quantity.
...
Return `number | null`, not raw strings.
