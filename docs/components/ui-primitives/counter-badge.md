...
**Status:** New  
**Recommended path:**
`src/components/ui/counter-badge/counter-badge.component.tsx`
...
**Used in screens**  
Header actions, checklist progress.

**Composition**  
Typography in small surface.
...
Clamp display with `maxCount` if needed.
