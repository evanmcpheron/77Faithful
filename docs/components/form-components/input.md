...
**Recommended path:** `src/components/form/input/input.component.tsx`

**Purpose**  
Standard text input with focus state and optional icons.
...
**Used in screens**  
Auth, property, room, job, profile, invite.

**Composition**  
FieldContainer + TextInput + IconButton.
...
Remove password-specific behavior after `PasswordInput` exists.
