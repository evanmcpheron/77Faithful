import type { IDocumentTimestamps, IPersistedTimestamp } from '../shared/persistence.types';
...
export type TBibleVersionId = (typeof BibleVersionId)[keyof typeof BibleVersionId];
...
} as const satisfies Record<keyof typeof BibleVersionId, IBibleVersionDefinition>;
...
export type TBibleVersionReleaseState =
  IBibleVersionPendingReviewState | IBibleVersionReleasedState | IBibleVersionWithdrawnState;
