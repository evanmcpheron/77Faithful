...
**Status:** New  
**Recommended path:**
`src/components/layout/bottom-sheet-layout/bottom-sheet-layout.component.tsx`

**Purpose**  
Internal bottom sheet content layout.
...
```ts
export interface IBottomSheetLayoutProps {
	children?: ReactNode;
	testID?: string;
}
```
