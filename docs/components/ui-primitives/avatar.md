...
**Status:** New  
**Recommended path:** `src/components/ui/avatar/avatar.component.tsx`

**Purpose**  
User/company image or initials.
...
**Used in screens**  
Dashboard, team rows, assignment modal, ID card.

**Composition**  
Uses `AppImage` fallback and Typography.
