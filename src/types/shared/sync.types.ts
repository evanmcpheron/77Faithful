...
export type TLocalSaveStatus = (typeof LocalSaveStatus)[keyof typeof LocalSaveStatus];
...
export interface IUnacknowledgedLocalSaveState {
  status: typeof LocalSaveStatus.SavedOnDevice | typeof LocalSaveStatus.NeedsReview;
...
export type TLocalSaveState = IUnacknowledgedLocalSaveState | IAccountAcknowledgedLocalSaveState;
