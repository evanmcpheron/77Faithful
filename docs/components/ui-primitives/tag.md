...
**Status:** New  
**Recommended path:** `src/components/ui/tag/tag.component.tsx`

**Purpose**  
Non-interactive compact metadata token.
...
**Used in screens**  
Property/company/checklist metadata.

**Composition**  
Typography inside surface.
...
export type TTagVariant = (typeof TagVariant)[keyof typeof TagVariant];
```
