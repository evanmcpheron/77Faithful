...
export const setupPractices = [
	{
		...
		examples: [
			'A walk, gentle stretching, chair-based movement, or another appropriate activity.',
		],
		boundaries:
	...
	},
	{
		...
		purpose:
			'Express love through practical help or sincere encouragement.',
		examples: [
	...
	},
	{
		...
		purpose:
			'Return to Scripture until its words and meaning become more familiar.',
		examples: [
	...
	},
	{
		...
		name: 'Gratitude',
		purpose:
			"Intentionally acknowledge God's gifts and respond with thanks.",
		examples: [
			'Name something to thank God for, speak gratitude to someone, or write privately.',
		],
		boundaries:
	...
	},
	{
		...
		purpose:
			'Engage with a suitable Christian book or other substantive Christian writing.',
		examples: [
			'Read a manageable section and consider how it relates to following Jesus.',
		],
		boundaries:
	...
	},
	{
		...
		name: 'Worship',
		purpose:
			'Intentionally honor God with attention, praise, and adoration.',
		examples: [
	...
	},
	{
		...
		examples: [
			'Share time, attention, resources, hospitality, or money when appropriate.',
		],
		boundaries:
	...
	},
	{
		...
		purpose:
			'Intentionally share a moment of faith with family or household members.',
		examples: [
			'Read a short passage together, pray together, or discuss an appropriate question.',
		],
		boundaries:
