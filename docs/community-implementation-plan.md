...
## Completion table — ticket 42 acceptance

| Ticket | Checked source/build                                                                    | Automated verification                                                                                                                         | Deployed/native/operator verification                                                                                                                                                             | Decision                                                                                                                        |
| ------ | --------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------- |
| 42     | `a1e0333402346dfd0ac8a0a25c27b95f28889236`; no application edit; Functions build passes | 88/88 existing synthetic emulator cases and 169/169 Node tests pass; real-callable post workflow fails 1/1; full Jest and root TypeScript fail | NOT RUN: no approved staging target, checked deployment/secret/index/job revisions, signed device build, real push receipt/open, independent reviewer process or manual accessibility walkthrough | **BLOCKED**; see `docs/community-acceptance-results.md` for per-requirement PASS/FAIL/NOT RUN evidence and owning prior tickets |
