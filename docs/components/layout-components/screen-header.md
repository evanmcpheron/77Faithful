...
**Status:** New  
**Recommended path:**
`src/components/layout/screen-header/screen-header.component.tsx`

**Purpose**  
Standard screen title/back/action header.
...
**Used in screens**  
Create/detail/settings screens.
