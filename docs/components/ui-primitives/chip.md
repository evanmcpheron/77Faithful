...
**Status:** New  
**Recommended path:** `src/components/ui/chip/chip.component.tsx`

**Purpose**  
Interactive filter/selection token.
...
**Used in screens**  
Filters, selected dropdown values.

**Composition**  
Pressable + Typography + optional icon.
...
Use for compact selectable tokens.
