...
**Status:** New  
**Recommended path:**
`src/features/jobs/components/job-assignment-modal.component.tsx`

**Purpose**  
Assign to internal member or external provider.
...
**Used in screens**  
Job create/list modal.

**Composition**  
Modal + RadioGroup + rows.

**Suggested props**

```ts
export interface IJobAssignmentModalProps {
	id?: string;
	disabled?: boolean;
	testID?: string;
...
Do not flatten provider workers.
