...
**Recommended path:** `src/components/ui/divider/divider.component.tsx`
...
**Used in screens**  
Auth social separator, tables, card sections.
...
export type TDividerVariant =
	(typeof DividerVariant)[keyof typeof DividerVariant];
```
...
Add orientation/inset only if used.
