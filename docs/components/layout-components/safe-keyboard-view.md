...
**Status:** New  
**Recommended path:**
`src/components/layout/safe-keyboard-view/safe-keyboard-view.component.tsx`

**Purpose**  
Reusable safe keyboard wrapper.
...
```ts
export interface ISafeKeyboardViewProps {
	children?: ReactNode;
	testID?: string;
}
```
