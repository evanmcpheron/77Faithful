...
**Status:** New  
**Recommended path:**
`src/components/layout/dashboard-header/dashboard-header.component.tsx`

**Purpose**  
Dashboard hero/greeting header.
...
**Used in screens**  
Owner/provider dashboards.

**Composition**  
Avatar, account trigger, banner.
