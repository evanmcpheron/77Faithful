...
**Status:** New  
**Recommended path:**
`src/features/jobs/components/job-damage-report-section.component.tsx`

**Purpose**  
Damage reports in job tracking.
...
**Composition**  
DamageReportCard/ListSection.

**Suggested props**

```ts
export interface IJobDamageReportSectionProps {
	id?: string;
	disabled?: boolean;
	testID?: string;
