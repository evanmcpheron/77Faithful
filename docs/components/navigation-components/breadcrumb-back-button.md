...
**Status:** New  
**Recommended path:**
`src/components/navigation/breadcrumb-back-button/breadcrumb-back-button.component.tsx`
...
**Composition**  
IconButton + optional label.

**Suggested props**

```ts
export interface IBreadcrumbBackButtonProps {
	children?: ReactNode;
	testID?: string;
}
```
