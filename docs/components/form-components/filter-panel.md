...
**Status:** New  
**Recommended path:**
`src/components/form/filter-panel/filter-panel.component.tsx`

**Purpose**  
Generic filter panel shell.
...
**Used in screens**  
Property, jobs, team, checklist filters.

**Composition**  
FormSection, fields, FormActions.
...
Domain filter panels wrap this.
