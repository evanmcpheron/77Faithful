...
**Status:** New  
**Recommended path:**
`src/components/ui/key-value-row/key-value-row.component.tsx`

**Purpose**  
Consistent label/value metadata row.
...
**Used in screens**  
Job detail, property access, ID card.

**Composition**  
Typography and optional icon.
...
export type TKeyValueRowVariant =
