...
- [Architecture decisions](docs/engineering/architecture-decisions.md): application/integration architecture, Firebase/curated Scripture, offline/security boundaries, backend/runtime choices, and technical data ownership.
...
## Firebase and Scripture content
