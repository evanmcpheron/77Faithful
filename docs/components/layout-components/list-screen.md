...
**Status:** New  
**Recommended path:**
`src/components/layout/list-screen/list-screen.component.tsx`

**Purpose**  
Convenience wrapper for FlashList screens.
...
**Used in screens**  
Properties, jobs, teams, checklists.

**Composition**  
Composes Screen list mode.
