...
**Recommended path:** `src/components/ui/typography/typography.component.tsx`

**Purpose**  
Theme-driven text primitive for all app copy.
...
Add `numberOfLines`, `align`, and relevant Text pass-through props only when
needed.
