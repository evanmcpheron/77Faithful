...
export type TCommunityContentReportTarget =
  ICommunityPostReportTarget | ICommunityReplyReportTarget | ICommunityMessageReportTarget;

export type TCommunityReportTarget =
  TCommunityContentReportTarget | ICommunityMemberReportTarget | IWholeCommunityReportTarget;
