...
**Status:** New  
**Recommended path:** `src/components/ui/empty-state/empty-state.component.tsx`

**Purpose**  
Reusable empty state content block.
...
Screen centering belongs to layout.
