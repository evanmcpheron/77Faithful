...
**Status:** New  
**Recommended path:**
`src/features/jobs/components/job-inventory-shortage-section.component.tsx`

**Purpose**  
Inventory shortages in job tracking.
...
**Composition**  
InventoryShortageRow/ListSection.

**Suggested props**

```ts
export interface IJobInventoryShortageSectionProps {
	id?: string;
	disabled?: boolean;
	testID?: string;
