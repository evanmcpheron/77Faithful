...
export type TStartJourneyOutcome =
	(typeof StartJourneyOutcome)[keyof typeof StartJourneyOutcome];

export interface IConfirmedJourneyStartResult {
	outcome:
		| typeof StartJourneyOutcome.Started
		| typeof StartJourneyOutcome.ExistingActiveJourney;
...
export type TStartJourneyResult =
	IConfirmedJourneyStartResult | IChangedJourneyStartReviewResult;
