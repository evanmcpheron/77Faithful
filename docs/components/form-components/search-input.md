...
**Status:** New  
**Recommended path:**
`src/components/form/search-input/search-input.component.tsx`

**Purpose**  
Search field with clear affordance.
...
**Used in screens**  
Property/job/checklist/team lists.
...
Do not fetch or filter internally.
