...
**Status:** New  
**Recommended path:**
`src/components/ui/status-badge/status-badge.component.tsx`

**Purpose**  
Standard status label and color mapping.
...
**Used in screens**  
Properties, jobs, checklists, team, inventory/damage.
...
export type TStatusBadgeVariant =
	(typeof StatusBadgeVariant)[keyof typeof StatusBadgeVariant];
```
...
Centralize labels such as Pending, In Progress, Completed, Overdue, Active.
