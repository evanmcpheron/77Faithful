...
**Status:** New  
**Recommended path:** `src/components/ui/error-state/error-state.component.tsx`
...
**Used in screens**  
Screen/list/modal errors.

**Composition**  
Typography and optional retry button.
...
export type TErrorStateVariant =
