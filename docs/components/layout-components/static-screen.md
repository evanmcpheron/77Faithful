...
**Status:** New  
**Recommended path:**
`src/components/layout/static-screen/static-screen.component.tsx`

**Purpose**  
Convenience wrapper for non-scroll screens.
...
**Used in screens**  
Simple states, fixed layouts.

**Composition**  
Composes Screen static mode.

**Suggested props**

```ts
export interface IStaticScreenProps {
	children?: ReactNode;
	testID?: string;
}
```
