...
**Status:** New  
**Recommended path:**
`src/features/jobs/components/job-checklist-execution-table.component.tsx`

**Purpose**  
Completed checklist execution table.
...
**Composition**  
DataTable + proof actions.

**Suggested props**

```ts
export interface IJobChecklistExecutionTableProps {
	id?: string;
	disabled?: boolean;
	testID?: string;
