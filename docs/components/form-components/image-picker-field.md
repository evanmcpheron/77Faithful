...
**Status:** New  
**Recommended path:**
`src/components/form/image-picker-field/image-picker-field.component.tsx`

**Purpose**  
Field for image add/remove.
...
**Used in screens**  
Property photos, room photos, proof, damage.

**Composition**  
FieldContainer + PhotoGrid + ImageUploader.

**Suggested props**

```ts
export interface IImagePickerFieldProps {
	label?: string;
	value?: string;
	disabled?: boolean;
	errorMessage?: string;
...
Upload orchestration belongs to hook/service.
