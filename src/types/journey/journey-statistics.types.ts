...
export type TJourneySummaryKind =
	(typeof JourneySummaryKind)[keyof typeof JourneySummaryKind];
...
export interface IDerivedJourneySummary {
	...
	ending:
		IFinalDaySummary | ICompletedJourneySummary | IEarlyEndedJourneySummary;
