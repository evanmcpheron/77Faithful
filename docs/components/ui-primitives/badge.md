...
**Status:** New  
**Recommended path:** `src/components/ui/badge/badge.component.tsx`

**Purpose**  
Small non-interactive metadata label.
...
**Used in screens**  
Property type, counts, metadata.

**Composition**  
Typography inside styled surface.
...
Use `StatusBadge` for status language.
