...
**Status:** New  
**Recommended path:** `src/components/ui/thumbnail/thumbnail.component.tsx`

**Purpose**  
Small image preview for rows/cards.
...
export type TThumbnailVariant =
	(typeof ThumbnailVariant)[keyof typeof ThumbnailVariant];
```
...
Do not own upload or viewer state.
