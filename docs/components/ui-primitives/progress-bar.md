...
**Status:** New  
**Recommended path:**
`src/components/ui/progress-bar/progress-bar.component.tsx`

**Purpose**  
Progress indicator for checklist/job completion.
...
**Used in screens**  
Checklist execution, job tracking.

**Composition**  
Styled track/fill views.
...
export type TProgressBarVariant =
...
Accept numbers; parent computes progress.
