...
**Recommended path:** `src/components/ui/card/card.component.tsx`

**Purpose**  
Generic card surface with border/shadow/padding.
...
**Used in screens**  
Auth card, property/job/checklist cards, stat cards.

**Composition**  
Wraps children with card styling.
...
Do not expose every `View` or `Pressable` prop.
